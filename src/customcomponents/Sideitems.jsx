...
export default function MenuPage() {
  ...
  const incrementCount = (item) => {
    ...
    const handlePostRequest = async (item, index) => {
      ...
      const foodNames = menuItems.slice(10,15).map(item => item.food_name); // Extract food_name
    ...
    function Addonsroute(){
      ...
      return(
       ...
       <div className="App1-1">
        <ul className='Scrollbar'>
          ...
          <li className='beefburgers'>Side Items</li>
      ...
      <div className="App2">
        ...
        {menuItems.length > 0 ? (
            menuItems.slice(10,15).map((list, item)=>(
