...
import "./MenuPage.css"; 
import BBQ from "./MENUPICS/BBQ PIC.png";
import CheeseB from "./MENUPICS/Cheese-burger.png";
import CheeseMadness from "./MENUPICS/Cheese-madness.png";
import DD from "./MENUPICS/D&D-burger.jpg";
import Mushroom from "./MENUPICS/mushroom-lover.png";
...
export default function MenuPage() {
  ...
  const incrementCount = (item) => {
    ...
    const handlePostRequest = async (item, index) => {
      ...
      const foodNames = menuItems.slice(5,10).map(item => item.food_name); // Extract food_name
    ...
    function Addonsroute(){
      ...
      return(
       ...
       <div className="App1-1">
        <ul className='Scrollbar'>
          ...
          <li className='beefburgers' >Chicken Burgers</li>
      ...
      <div className="App2">
        ...
        {menuItems.length > 0 ? (
            menuItems.slice(5,10).map((list, item)=>(
